...
<html>
    <head>
        <link rel="shortcut icon" href="img/lf.png" />
        <title>eShopBD</title>
        <meta charset="UTF-8">
           ...
           <footer class="footer">
               <div class="container">
                <center>
                   ...
                   <p>This website is developed by Azharul Islam</p>
               </center>
               </div>
           </footer>
        </div>
